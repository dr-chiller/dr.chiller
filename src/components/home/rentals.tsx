            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 grid md:grid-cols-2 gap-10 items-center">
                ...
                <div>
                    ...
                    <p className="text-gray-700 dark:text-gray-300 mb-6 leading-relaxed">
                        Whether you need to cool down a large space, maintain process temperatures or provide power to a site,
                        we offer reliable rental solutions for A/C units, water chillers and diesel generators. Perfect for events,
                        industrial applications, mock-up rooms and emergency backup needs.
                    </p>

                    <p className="text-gray-700 dark:text-gray-300 mb-8 leading-relaxed">
                        All rental units are quick to deploy, energy-efficient and fully maintained by our technical team — ensuring
                        comfort, performance and uninterrupted operation whenever you need it.
                    </p>
