const HeatExchangersSubSection = () => {
    return (
        <section className="flex flex-col md:flex-row items-center gap-10 py-12 px-6 sm:px-16 bg-white dark:bg-gray-900 rounded-2xl shadow-lg">
            {/* Image */}
            <div className="flex-1">
                <div className="overflow-hidden rounded-xl shadow-md transition-transform duration-500 hover:scale-105">
                    <img
                        src="/cooling-tower.jpg"
                        alt="Cooling Tower"
