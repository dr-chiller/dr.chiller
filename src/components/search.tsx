        ...
        <>
            ...
            <div className="relative z-40">
                <button
                    ...
                    className="text-emerald-500 mt-2 md:mt-0 dark:text-emerald-400 hover:text-emerald-400 dark:hover:text-emerald-500 transition"
                >
                    <Search size={20} />
                </button>
                            ...
                            <ul className="mt-1 bg-white dark:bg-gray-900 rounded-md shadow-lg max-h-80 overflow-y-auto">
                                {results.map((item, i) => (
                                    ...
                                    >
                                        ...
                                        <span className="text-gray-500 dark:text-gray-400 text-sm ml-1">({item.category})</span>
                                    </li>
                                ))}
                            </ul>
                        )}
